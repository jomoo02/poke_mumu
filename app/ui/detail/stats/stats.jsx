...
function Header({ type, language }) {
  ...
  return (
    ...
    >
      <div className="col-span-5 border-b border-[#fafaf9] py-[3px]">{headerText}</div>
      <div />
      <div className="col-span-3 py-[3px]">{baseText}</div>
      <div className="py-[3px]">{effortText}</div>
    </div>
  );
}
...
function StatRow({
  ...
  return (
    <div className="grid grid-cols-5 py-1 sm:py-1.5 gap-x-1 sm:gap-x-3 items-center">
