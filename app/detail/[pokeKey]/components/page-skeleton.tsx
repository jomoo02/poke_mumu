...
import DefenseCompatibilitySkeleton from '../modules/defense-compatibility-2/components/defense-compatibility-skeleton';
import EvolutionSkeleton from '../modules/evolution-2/components/evolution-skeleton';
